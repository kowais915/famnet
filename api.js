...
app.get("/", (req, res) => {
  res.json({
    ...
    documentation:
      "https://famnet-grhqstk6u-kowais915s-projects.vercel.app/docs",
  });
});
...
app.get("/api/all", (req, res) => {
  res.json({
    msg: "Here is all the content for family planning and counseling",
  });
});
